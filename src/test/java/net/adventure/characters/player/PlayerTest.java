...
class PlayerTest {
	...
	void shouldSetBlockToTrue() {
		Player p = new Player("Test", 0, 0, 0);
		p.setBlock(true);
	...
	void shouldSetHealthToFifty() {
		Player p = new Player("Test", 100, 0, 0);
		p.setHealth(50);
	...
	void shouldSubtractOneFromPotionCount() {
		Player p = new Player("Test", 0, 0, 2);
		p.setPotion();
	...
	void shouldReturnAttackDamageCal() {
		Player p = new Player("Test", 0, 15, 0);
	...
	void shouldAddFifteenToHealth() {
		Player p = new Player("Test", 75, 0 , 1);
		p.heal();
